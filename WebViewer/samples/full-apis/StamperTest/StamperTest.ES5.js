!(function(t) {
          ...
          S
            ? ((v = e(function(t, e, r, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(e)) {
                  if (!(e instanceof $ || 'ArrayBuffer' == (a = b(e)) || 'SharedArrayBuffer' == a)) return xt in e ? Mt(v, e) : It.call(v, e);
                  (i = e), (p = Pt(r, n));
                  var y = e.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, e) {
    ...
    function U(t, n, e, r) {
      var o = h(+e);
      if (o + n > t[j]) throw b('Wrong index!');
      var i = t[M]._b,
        u = o + t[I],
        c = i.slice(u, u + n);
    ...
    function W(t, n, e, r, o, i) {
      var u = h(+e);
      if (u + n > t[j]) throw b('Wrong index!');
      for (var c = t[M]._b, a = u + t[I], f = r(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, b = '', w = 0, _ = 0; _ < m.length; _++) {
            ...
            } else j = y(F, p, P, O, A, n);
            P >= w && ((b += p.slice(w, P) + j), (w = P + F.length));
          }
          return b + p.slice(w);
        },
      ];
            ...
            var t,
              r =
                ((t = regeneratorRuntime.mark(function t() {
                  var e, r, o, i, u, c, a, f, s, l, p, h, v, y, g, d, m, S, x, b, w, _, F, P, O, E, A, M, j, I, k, D, T, R, N, L, C, B, z, U, W, V, G, H, Y, q, $, K, J;
                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 190:
                            return (j = t.sent), M.stampText(A, 'Goodbye\nMoon', j), (t.next = 194), A.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 194:
                            return (I = t.sent), saveBufferAsPDFDoc(I, 'newsletter.ex5.pdf'), (t.next = 198), n.endDeallocateStack();
                          case 198:
                            t.next = 204;
                            break;
                          case 200:
