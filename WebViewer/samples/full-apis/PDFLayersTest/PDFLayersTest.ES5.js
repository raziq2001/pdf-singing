  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, y, d, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? F : S('values'), keys: d ? F : S('keys'), entries: M }), g)) for (x in m) x in E || i(E, x, m[x]);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, S = 0, w = []; S < p.length; ) {
              ...
              var _,
                O = a(m, v ? p : p.slice(S));
              if (null === O || (_ = l(c(m.lastIndex + (v ? 0 : S)), p.length)) === b) S = u(p, S, d);
              else {
          ...
          c = (function() {
            var t = o(
              regeneratorRuntime.mark(function t() {
                var o, c, a, f, s, l, p, h, v, y, d, g, m, x, b, S, w, _, O, E, P, F, M, A, j;
