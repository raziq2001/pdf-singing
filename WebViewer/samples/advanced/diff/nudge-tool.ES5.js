!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), b = o(g), m = e(c, v, 3), S = u(b.length), x = 0, w = r ? p(n, S) : a ? p(n, 0) : void 0; S > x; x++)
          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = x(r)) || 'SharedArrayBuffer' == a)) return St in r ? Mt(v, r) : jt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    ((n = t.exports = function(t, n, r, l, h) {
      ...
      if (i(g)) {
        for (p = c(t.length); p > m; m++) if ((d = n ? b(u((v = t[m]))[0], v[1]) : b(t[m])) === f || d === s) return d;
      } else for (y = g.call(t); !(v = y.next()).done; ) if ((d = o(y, b, v.value, n)) === f || d === s) return d;
    }).BREAK = f),
      (n.RETURN = s);
  },
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || T(t, C, E(1, {})), (t[C][n] = !0)), H(t, n, r)) : T(t, n, r)
        );
      },
      X = function(t, n) {
        m(t);
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            g = 0,
            b = s(h);
          if ((d && (y = e(y, v > 2 ? arguments[2] : void 0, 2)), null == b || (p == Array && c(b)))) for (r = new p((n = a(h.length))); n > g; g++) f(r, g, d ? y(h[g], g) : h[g]);
          else for (l = b.call(h), r = new p(); !(o = l.next()).done; g++) f(r, g, d ? u(l, y, [o.value, g], !0) : o.value);
          return (r.length = g), r;
        },
      }
    );
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < b.length; _++) {
            m = b[_];
            for (var E = String(m[0]), O = f(s(u(m.index), h.length), 0), P = [], F = 1; F < m.length; F++) P.push(void 0 === (S = m[F]) ? S : String(S));
            var A = m.groups;
            if (p) {
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      m = (t.exports = r(58)('WeakMap', g, b, f, !0, !0));
    h &&
      p &&
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        m = u[g],
        S = m && m.prototype;
      if (S && (S[s] || c(S, s, h), S[l] || c(S, l, g), (a[g] = h), b)) for (d in e) S[d] || i(S, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
      ...
      var r = (function(t) {
        ...
        return (
          ...
          (t.mark = function(t) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, v) : ((t.__proto__ = v), a(t, c, 'GeneratorFunction')), (t.prototype = Object.create(b)), t;
          }),
          (t.awrap = function(t) {
            return { __await: t };
          }),
          ...
          ((s = !h && S && void 0 !== S[f]) && c(b, f)) ||
            ...
            (b[f] =
              p && 'function' != typeof S[f]
                ...
                ? i(Function.call, l)
                : l),
            y && (((b.virtual || (b.virtual = {}))[f] = l), n & t.R && m && !m[f] && u(m, f, l)));
      };
  ...
  function(t, n) {
    !(function(t) {
      ...
      t.NudgeTool = {
        initNudgeTool: function(t, p, b) {
          (e = t), (y = p), (n = b);
          var m = document.createElement('div');
          m.setAttribute('id', 'nudge-diff-tool'),
            (m.innerHTML =
