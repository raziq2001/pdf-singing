  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Gt = function(t, n) {
          return Dt(t, (n = m(n, !0))) ? h(2, t[n]) : B(t, n);
        },
        Ut = function(t, n, r) {
          return !(Dt(t, (n = m(n, !0))) && w(r) && x(r, 'value')) || x(r, 'get') || x(r, 'set') || r.configurable || (x(r, 'writable') && !r.writable) || (x(r, 'enumerable') && !r.enumerable)
            ? V(t, n, r)
            : ((t[n] = r.value), t);
        };
      mt || ((U.f = Gt), (G.f = Ut)),
